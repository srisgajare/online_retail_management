    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ShoppersPoint.Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ShoppersPoint.Category')),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ShoppersPoint.Products')),
            ],
            options={
                'verbose_name': 'Mobile',
